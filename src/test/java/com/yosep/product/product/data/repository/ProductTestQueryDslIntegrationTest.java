...
@Slf4j
public class ProductTestQueryDslIntegrationTest extends BaseIntegrationTest {
    private final ProductTestRepositoryQueryDsl productTestRepositoryQueryDsl;

    @Autowired
    public ProductTestQueryDslIntegrationTest(ProductTestRepositoryQueryDsl productTestRepositoryQueryDsl) {
